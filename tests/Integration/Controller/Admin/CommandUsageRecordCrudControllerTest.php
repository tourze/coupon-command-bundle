...
class CommandUsageRecordCrudControllerTest extends TestCase
{
    private CommandUsageRecordCrudController $controller;

    protected function setUp(): void
    {
        $this->controller = new CommandUsageRecordCrudController();
    }

    public function test_get_entity_fqcn(): void
    {
        $fqcn = $this->controller::getEntityFqcn();
        $this->assertEquals(CommandUsageRecord::class, $fqcn);
    }
