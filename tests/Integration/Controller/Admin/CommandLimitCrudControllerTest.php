...
class CommandLimitCrudControllerTest extends TestCase
{
    private CommandLimitCrudController $controller;

    protected function setUp(): void
    {
        $this->controller = new CommandLimitCrudController();
    }

    public function test_get_entity_fqcn(): void
    {
        $fqcn = $this->controller::getEntityFqcn();
        $this->assertEquals(CommandLimit::class, $fqcn);
    }
